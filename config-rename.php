...
$rename = array(
  ...
  "Alaska Saedelaere; Testare und Kummerog" => "[[Alaska Saedelaere|Saedelaere, Alaska]]; Testare und Kummerog",
  "Cistolo Khan" => "[[Cistolo Khan|Khan, Cistolo]]",
  "Corn Markée" => "[[Corn Markée|Markée, Corn]]",
  "Domino Ross" => "[[Domino Ross|Ross Domino]]",
  "Ernst Ellert" => "[[Ernst Ellert|Ellert, Ernst]]",
  "Ernst Ellert; Mutantengaben" => "[[Ernst Ellert|Ellert, Ernst]]; [[Mutant]]engaben",
  "Fee Kellind" => "[[Fee Kellind|Kellind, Fee]]",
  "Galbraith Deighton" => "[[Galbraith Deighton|Deighton, Galbraith]]",
  "Homer G. Adams" => "[[Homer G. Adams|Adams, Homer G.]]",
  "Jar Makromeer" => "[[Jar Makromeer|Makromeer, Jar]]",
  "Jedder Colusha" => "[[Jedder Colusha|Colusha, Jedder]]",
  "Jon Cavalieri" => "[[Jon Cavalieri|Cavalieri, Jon]]",
  ...
  "Nico Knobloch" => "[[Nico Knobloch|Knobloch, Nico]]",
  "Noviel Residor" => "[[Noviel Residor|Residor, Noviel]]",
  "Paola Daschmagan" => "[[Paola Daschmagan|Daschmagan, Paola]]",
  "Perry Rhodan" => "[[Perry Rhodan|Rhodan, Perry]]",
